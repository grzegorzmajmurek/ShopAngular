...
import {EditorsecondComponent} from './shop/users/editorsecond/editorsecond.component';
...
const routes: Routes = [
  ...
  {path: 'shop', component: ShopComponent, children: [
      ...
      {path: 'users/editorsecond', component: EditorsecondComponent},
      {path: 'users/editorsecond/:id', component: EditorsecondComponent},
    ]
  }
];
